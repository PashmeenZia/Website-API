...
return(
<section className="text-gray-600 body-font  bg-gray-900 relative">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-bold font-serif title-font mb-4 text-gray-200">Contact Us</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed  text-white text-base"> Please fill out the form below and share your valuable suggestions and feedback with us..</p>
    </div>
