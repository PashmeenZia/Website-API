...
const Menu = () => {
  ...
  // Fetch products and load saved cart from localStorage
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen py-6">
      <div
        ...
        style={{
          backgroundImage: "url('image/menu-bg.jpg')",
        }}
      ></div>
      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">
            Delicious & Special Food In Our Menu
          </h1>
          <p className="text-xl text-white">
            Explore Our Menu with Different Dishes Order Now!
          </p>
        </div>

        {/* Product section */}
        <div className="max-w-6xl mx-auto p-4 grid grid-col-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-red-700">
        ...
        <div className="max-w-6xl mx-auto mt-8">
          <button
            onClick={toggleCart}
            className="bg-blue-600 text-white py-3 px-6 rounded-lg text-lg shadow-md hover:bg-blue-800 transition duration-300 ease-in-out transform hover:scale-110"
          >
                    ...
                    {cart.map((product, index) => (
                      ...
                      >
                        <img
                          src={product.image}
                          alt={product.name}
                          className="w-20 h-40 sm:w-24 sm:h-24 inline-block transition-transform duration-300 ease-in-out hover:scale-110 transform text-black"
                        />
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:w-96">
              ...
              <div className="mt-6 flex justify-between">
                <button
                  ...
                  className="bg-slate-600 text-white py-2 px-6 rounded-lg text-lg"
                >
                  Close
                </button>
                ...
                <button
                  onClick={() =>
                    alert("Order Confirmed. It will be delivered soon!")
                  }
                  className="bg-green-600 text-white py-2 px-6 rounded-lg text-lg"
                >
                  Confirm Order
                </button>
              </div>
